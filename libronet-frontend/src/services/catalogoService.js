// =============================================
// catalogoService.js
// Obtiene los catálogos desde el backend.
// Endpoints esperados: GET /api/catalogos/estados-civiles
//                      GET /api/catalogos/tipos-documento
//                      GET /api/catalogos/formaciones
// Si tu backend aún no los tiene, usa los datos
// estáticos como fallback (ver comentario abajo).
// =============================================
...
async function fetchCatalog(url, fallback) {
  try {
    ...
    // Fallback estático — reemplaza con los IDs reales de tu BD
    return fallback;
  }
}
