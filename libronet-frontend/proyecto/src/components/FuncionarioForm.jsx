    ...
    <div className="form-card">
      ...
      <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-grid form-grid--2">
            ...
            {!isEdit && (
              <div className="form-field">
                ...
                <input
                  id="numeroDocumento" name="numeroDocumento" type="number"
                  placeholder="Ej: 1234567890"
                  value={values.numeroDocumento} onChange={handleChange}
            ...
            <div className="form-field">
              ...
              <select
                id="tipoDocId" name="tipoDocId"
                value={values.tipoDocId} onChange={handleChange}
                className={errors.tipoDocId ? 'error' : ''} disabled={loadingCat}
              >
        ...
        <div className="form-section">
          ...
          <div className="form-grid form-grid--2">
            ...
            <div className="form-field">
              ...
              <input
                id="fechaIngreso" name="fechaIngreso" type="date"
                value={values.fechaIngreso} onChange={handleChange}
            ...
            <div className="form-field">
              ...
              <select
                id="estadoCivilId" name="estadoCivilId"
                value={values.estadoCivilId} onChange={handleChange}
                className={errors.estadoCivilId ? 'error' : ''} disabled={loadingCat}
              >
                <option value="">{loadingCat ? 'Cargando...' : '-- Seleccionar --'}</option>
            ...
            <div className="form-field form-field--full">
              ...
              <select
                id="formacionId" name="formacionId"
                value={values.formacionId} onChange={handleChange}
                className={errors.formacionId ? 'error' : ''} disabled={loadingCat}
              >
                <option value="">{loadingCat ? 'Cargando...' : '-- Seleccionar --'}</option>
              ...
              {familiares.map((fam, idx) => (
                <div key={idx} className="familiar-row">
                  <div className="form-field">
                    <label>Nombre</label>
                    <input
                      type="text" placeholder="Nombre del familiar"
                  ...
                  <div className="form-field">
                    ...
                    <input
                      type="text" placeholder="Ej: Hijo/a, Cónyuge"
                      value={fam.parentesco}
                      onChange={e => handleFamiliarChange(idx, 'parentesco', e.target.value)}
                    />
                  </div>
                  <button type="button" className="btn-remove" onClick={() => removeFamiliar(idx)}>×</button>
                </div>
              ))}
            </div>
          )}
        ...
        <div className="form-actions">
          <button type="submit" className="btn btn--primary" disabled={loading || loadingCat}>
